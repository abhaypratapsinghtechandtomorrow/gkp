...
const tests = [
  { id: 1, name: 'Complete Blood Count (CBC)', description: 'Measures different parts of your blood, including red blood cells, white blood cells, and platelets.', price: 300, popular: true },
  { id: 2, name: 'Lipid Profile', description: 'Measures cholesterol levels and triglycerides to assess heart disease risk.', price: 500, popular: true },
  { id: 3, name: 'Thyroid Profile (T3, T4, TSH)', description: 'Evaluates thyroid gland function.', price: 600, popular: true },
  { id: 4, name: 'Liver Function Test (LFT)', description: 'Measures enzymes, proteins, and substances produced by the liver to check its health.', price: 450, popular: false },
  { id: 5, name: 'Kidney Function Test (KFT)', description: 'Evaluates how well the kidneys are working.', price: 500, popular: false },
  { id: 6, name: 'Blood Sugar Fasting & PP', description: 'Measures blood glucose levels to diagnose or monitor diabetes.', price: 150, popular: true },
  { id: 7, name: 'HbA1c', description: 'Provides an average of your blood sugar control over the past 2 to 3 months.', price: 400, popular: true },
  { id: 8, name: 'Vitamin D (25-OH)', description: 'Checks for vitamin D deficiency, important for bone health.', price: 800, popular: false },
  { id: 9, name: 'ECG (Electrocardiogram)', description: 'Records the electrical signal from the heart to check for different heart conditions.', price: 350, popular: true },
  { id: 10, name: 'Urine Routine & Microscopy', description: 'Checks for infections, kidney disease, or diabetes through a urine sample.', price: 150, popular: true },
  { id: 11, name: 'X-Ray Chest PA View', description: 'Produces images of the heart, lungs, airways, blood vessels and the bones of the spine and chest.', price: 300, popular: false },
  { id: 12, name: 'Full Body Health Checkup', description: 'Comprehensive package covering 60+ parameters including Liver, Kidney, Thyroid, and Lipid profile.', price: 1499, popular: true }
];
...
router.get('/tests', (req, res) => res.json(tests));
router.get('/packages', (req, res) => res.json(packages));
router.get('/organs', (req, res) => res.json(organs));
